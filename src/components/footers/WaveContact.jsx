...
const infos = [
  {
    icon: <PhoneIcon />,
    description: "+1 814 528-3891"
  },
  {
    icon: <MailIcon />,
    description: "sam-lehman@gmail.com",
  }
];
...
const socialIcons = [
  {
    ...
    label: "GitHub",
    href: "https://github.com/samlehman617/developer-portfolio"
  },
  {
    icon: (
      <svg
...
ContactFooter.shortname = 'WaveContact';
ContactFooter.icon = PermContactCalendarIcon;
ContactFooter.args = {
  color: {
...
export default withWidth()(withStyles(styles, { withTheme: true })(ContactFooter));
