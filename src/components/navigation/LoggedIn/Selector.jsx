...
import persons from "../../../data/dummy_data/persons";
...
function Selector(props) {
  ...
  const selectDashboard = useCallback(() => {
    smoothScrollTop();
    document.title = "Sam Lehman - Dashboard";
    setSelectedTab("Dashboard");
    if (!hasFetchedCardChart) {
      setHasFetchedCardChart(true);
      import("../../CardChart").then((Component) => {
  ...
  const selectSubscription = useCallback(() => {
    smoothScrollTop();
    document.title = "Sam Lehman - Subscription";
...
export default withStyles(styles, { withTheme: true })(memo(Selector));
