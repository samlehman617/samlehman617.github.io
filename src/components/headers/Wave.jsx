...
function WaveHeader(props) {
  ...
  return (
    // <div className={className} style={{ background: upperColor, transform: 'rotate(180deg)' }} {...rest}>
...
WaveHeader.shortname = 'Wave';
WaveHeader.icon = WavesIcon;
WaveHeader.args = {
  color: {
...
const Wave = withStyles(styles)(WaveHeader);
