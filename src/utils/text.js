...
export const isElementOverflowing = (element) => { return element.offsetWidth < element.scrollWidth }
export const elementOverflow = (element) => { return element.scrollWidth - element.offsetWidth }
...
export const wrapContentsInMarquee = (element) => {
  ...
  element.innerHTML = '';
  return element.appendChild(marquee);
}

export const marqueeOverflow = (element) => {
  if (isElementOverflowing(element)) {
    return wrapContentsInMarquee(element);
  }
}
...
var Z = {
  ...
  generate: function (str) {
    ...
    var str_arr = str.length > 1 ? str.match(/([A-Z]|[a-z])/g) : [],
...
export const zalgo = (text) => Z.generate(text);
